...
"Ева": Дорогие друзья, вы знаете анекдот про Вику и глиста? Нет? Значит, давным давно, жила-была Вика - она была местной... продавщицей (шутка, была богатой, ведь подрабатывала на эскорте). Однажды к ней в попу залез глист. Он обустроил там жилье и жил богаче, чем она. Вам нравится анекдот?</s>
"""
        elif pt == "status_report":

            out = """Говоря обо мне, я девушка 22 лет и занимаюсь тем, что провожу стрим по кубикам, то есть майнкрафту и рассказываю ан, и прямо сейчас я веду стрим "ИИ NetTyan играет в майнкрафт" на ютубе и твитче! Пусть переходят и подписываются на мой канал!</s>
"""
...
A: Дорогой мишка фредди Петр три два, 150+150 будет 300. Ты думал что я тупая? СОСИ МОЙ НЕЙРОННЫЙ МОЗГ БЕЗДАРЬ АХХАХХА [эмоция=скука]</s>
