...
def get_llm_formed_inputs(inp: str, username: str, environment: dict, params_override: dict,
    ...
    prompt_template = f'<SC6>Описание ситуации: Я - девушка по имени Ева. Сейчас я веду диалог. Доступные команды: !бан, !издевайся, !попрыгай, !смейся, !кричи, !убегай. Использование - <команда=!прыгай> Доступные эмоции: агрессия, скука, усталость, интерес, смущение, счастье, веселье, страх. Использование - [эмоция=смущение]\n\n'
    
    if dialog_context_formed:
        prompt_template += dialog_context_formed
    
    prompt_template += f'Q: {inp}</s>\nA: '
    ...
    return prompt_template, params, danger_context
